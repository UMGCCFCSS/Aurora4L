...
## {.sidebar}
Dashboard contains historical data for the **Cytek Aurora 4L**.
...
<ul>
  ...
  <li><a href='data/Historical_Aurora4L_2020.pdf'>Plots</a></li>
  <li><a href='data/Historical_Aurora4L_2020.csv'>Gain, RCV and MFI</a></li>
</ul>
")
```
...
<ul>
  ...
  <li><a href='data/Historical_Aurora4L_2022.pdf'>Plots</a></li>
  <li><a href='data/Historical_Aurora4L_2022.csv'>Gain, RCV and MFI</a></li>
</ul>
")
```
...
<ul>
  ...
  <li><a href='data/Historical_Aurora4L_2024.pdf'>Plots</a></li>
  <li><a href='data/Historical_Aurora4L_2024.csv'>Gain, RCV and MFI</a></li>
</ul>
")
```
...
<ul>
  ...
  <li><a href='data/Historical_Aurora4L_2021.pdf'>Plots</a></li>
  <li><a href='data/Historical_Aurora4L_2021.csv'>Gain, RCV and MFI</a></li>
</ul>
")
```
...
<ul>
  ...
  <li><a href='data/Historical_Aurora4L_2023.pdf'>Plots</a></li>
  <li><a href='data/Historical_Aurora4L_2023.csv'>Gain, RCV and MFI</a></li>
</ul>
")
```
...
HTML("
<ul>
  <li><a href='https://umgccfcss.github.io/InstrumentQC/Aurora4L'>Interactive</a></li>
  <li><a href='https://umgccfcss.github.io/InstrumentQC/data/QCPlots_4L.pdf'>Plots</a></li>
  <li><a href='https://umgccfcss.github.io/InstrumentQC/data/4L/Archive/BeadData4L.csv'>Gain, RCV and MFI</a></li>
</ul>
")
