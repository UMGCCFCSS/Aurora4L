...
<ul>
  ...
  <li><a href='data/Historical_Aurora4L_2020.csv'>Gain and MFI</a></li>
</ul>
")
```
...
<ul>
  ...
  <li><a href='data/Historical_Aurora4L_2022.csv'>Gain and MFI</a></li>
</ul>
")
```
...
<ul>
  ...
  <li><a href='data/Historical_Aurora4L_2024.csv'>Gain and MFI</a></li>
</ul>
")
```
...
<ul>
  ...
  <li><a href='data/Historical_Aurora4L_2021.csv'>Gain and MFI</a></li>
</ul>
")
```
...
<ul>
  ...
  <li><a href='data/Historical_Aurora4L_2023.csv'>Gain and MFI</a></li>
</ul>
")
```
...
<ul>
  ...
  <li><a href='https://umgccfcss.github.io/InstrumentQC/data/4L/Archive/BeadData4L.csv'>Gain and MFI</a></li>
</ul>
")
